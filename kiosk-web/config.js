...
const CONFIG = {
    ...
    RECONNECT_INTERVAL: PUBLIC_RUNTIME_CONFIG.RECONNECT_INTERVAL || 5000, // 5 saniye

    // Progress bar güncellemeleri
    UI_UPDATE_INTERVAL: PUBLIC_RUNTIME_CONFIG.UI_UPDATE_INTERVAL || 100, // 0.1 saniye (görsel akıcılık için)
    SOCKET_EMIT_INTERVAL: PUBLIC_RUNTIME_CONFIG.SOCKET_EMIT_INTERVAL || 5000 // 5 saniye (sunucu yükü için)
};
