...
async function migrate() {
    ...
    try {
        ...
        await db.query('CREATE UNIQUE INDEX IF NOT EXISTS idx_next_song_votes_guest_ip_ua_once ON next_song_votes(round_id, ip_hash, user_agent_hash) WHERE user_id IS NULL AND ip_hash IS NOT NULL AND user_agent_hash IS NOT NULL');
