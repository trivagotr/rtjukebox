...
import { fetchPodcasts, fetchSpotifyUrl, Podcast } from '../services/podcastService';
...
const PodcastScreen = () => {
    ...
    const handlePodcastPress = async (podcast: Podcast) => {
        if (playingId === podcast.id) return;
            ...
            if (!url) {
                ...
                if (fetchedUrl) {
                    ...
                    setPodcasts(prev => prev.map(p =>
                        p.id === podcast.id ? { ...p, spotifyUrl: url } : p
                    ));
                } else {
                    url = podcast.url;
                }
                    ...
                    <FlatList
                        ...
                        ListEmptyComponent={() => (
                            <View style={styles.emptyContainer}>
                                ...
                                <Text style={styles.emptyText}>Henüz podcast bulunmuyor veya bağlantı hatası.</Text>
                                <TouchableOpacity style={styles.retryButton} onPress={loadPodcasts}>
...
const styles = StyleSheet.create({
    ...
    emptyText: { color: COLORS.textMuted, marginTop: SPACING.md, marginBottom: SPACING.lg },
    retryButton: {
